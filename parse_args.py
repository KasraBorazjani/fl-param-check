...
def parse_arguments():
    ...
    ## Training Param Args ##
    parser.add_argument('--sgd_per_round', type=int, default=5, help='number of local epochs per federated round (default: 5)')
    parser.add_argument('--num_clients', type=int, default=30, help='number of clients simulated (default: 30)')
    parser.add_argument('--neighbors_per_client', type=int, default=5, help='number of neighbors per client (default: 5)')
    parser.add_argument('--model_inertia', type=float, default=0.05, help='inertia for model aggregation (default: 0.05)')


    ## Dataset Args ##
    parser.add_argument('--total_ds_len', type=int, default=300, help='total dataset length for each client (default: 300)')
    ...
    parser.add_argument('--num_fed_rounds', type=int, default=70, help='maximum number of federated rounds to run the code for (default: 70)')
